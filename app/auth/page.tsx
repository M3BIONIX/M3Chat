...
export default function LoginPage() {
    const { setShowSignUpModal, authState} = useAuthHook();
    const { authenticateWithGithub, authenticateWithGoogle } = useUserHook();
    const showForgotPassword = authState.data.showForgotPassword;
                ...
                <div className="w-full max-w-md relative z-10">
                    <div className="bg-[#1a1a1a]/80 backdrop-blur-xl rounded-3xl border border-gray-800 p-8 space-y-8 shadow-2xl">
                        ...
                        <div className="text-center space-y-4">
                            ...
                            <div>
                                <h1 className="text-3xl text-white mb-2">
                                    {showSignUpModal ? 'Create Account' : 'Welcome Back'}
                                </h1>
                                <p className="text-gray-400">
                                    {showSignUpModal ? 'Get started with M3 Chat today' : 'Sign in to continue your conversations'}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button onClick={authenticateWithGoogle} className="h-12 flex items-center justify-center bg-[#0f0f0f] border-gray-700 text-gray-300 hover:bg-gray-800 hover:text-white rounded-xl">
                            ...
                            <button onClick={authenticateWithGithub} className="h-12 flex items-center justify-center bg-[#0f0f0f] border-gray-700 text-gray-300 hover:bg-gray-800 hover:text-white rounded-xl">
